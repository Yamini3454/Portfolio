                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
                            <div className='p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all'>
                                ...
                                <ul className='list-disc list-inside text-gray-300 space-y-2'>
                                    <li>
                                        <strong>MCA</strong> - Aurora's Pg College 
                                        (2023 - 2025)
                                    </li>
                                    <li>
                                        <strong>B.SC. in Computer science</strong> - DBPM degree College 
                                        (2019 - 2022)
                                    </li>
                                    <li>
                                        Relevant Coursework: Web Development, Data Structures and Algorithms, Machine Learning...
                                    </li>
                                </ul>    
                            </div>
                            <div className='p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all'>
